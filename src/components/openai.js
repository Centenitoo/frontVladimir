...
export default function OpenAI() {
    ...
    return (
        ...
        <div style={{ marginTop: '9rem' }}>
          ...
          <button className="pinterest-btn" onClick={() => setSelectedService("tra")}>{t("music name translator")}</button>
          <button className="pinterest-btn" onClick={() => setSelectedService("list")}>{t("list of music")}</button>
          <button className="pinterest-btn" onClick={() => setSelectedService("clas")}>{t("list of music genres")}</button>
          ...
          {selectedService === "emo" && (
            <div>
              <main>
                ...
                <br />
                <div style={{color: "white"}} className="text-center fly">{resultemo}</div>
                {user && (
                  <SavePrompt
                    user={user}
          ...
          {selectedService === "text" && (
            <div>
              <main>
                <h3 className="text-center fly">{t("characters")}</h3>
                ...
                <br />
                <div style={{color: "white"}} className="text-center fly">{resultext}</div>
                {user && (
                  <SavePrompt
                    user={user}
                    model="text-davinci-003"
          ...
          {selectedService === "tra" && (
            <div>
              <main>
                ...
                <br />
                <div style={{color: "white"}} className="text-center fly">{resultra}</div>
                {user && (
                  <SavePrompt
                    user={user}
                    model="text-davinci-003"
          ...
          {selectedService === "list" && (
            <div>
              <main>
                <h3 className="text-center fly">{t("music of the genre")}</h3>
                <form onSubmit={onSubmitlist}>
                  <div className="cont-center">
                    <input
                      type="text"
                      name="animal"
                      placeholder={t("genre of music")}
                  ...
                  <br />
                  <div className="cont-center">
                    <input type="submit" className="pinterest-btn pinterest-btn--black" value={t("generate music")} />
                  </div>
                </form>
                <br />
                <div style={{color: "white"}} className="text-center fly">{resullis}</div>
                {user && (
                  <SavePrompt
                    user={user}
                    model="text-davinci-003"
          ...
          {selectedService === "clas" && (
            <div>
              <main>
                <h3 className="text-center fly">{t("genre of music")}</h3>
                ...
                <br />
                <div style={{color: "white"}} className="text-center fly">{resultclas}</div>
                {user && (
                  <SavePrompt
                    user={user}
                    model="text-davinci-003"
