  ...
  return (
    <div className="About-us sombra" id="Caja" style={{ marginTop: '8rem' }}>
      ...
      <div id="Formulario-Info">
        <p style={{color: "white"}} className="Espacio Espacio2">Titulo:</p>
        <p style={{color: "white"}} className="Espacio Espacio2">Autor:</p>
        <p style={{color: "white"}} className="Espacio Espacio2">Clasificacion:</p>
        <p style={{color: "white"}} className="Espacio Espacio2">En Spotify:</p>
        <p style={{color: "white"}} className="Espacio Espacio2">Duracion:</p>
        <p style={{color: "white"}} className="Espacio Espacio2">Genero:</p>
        <p style={{color: "white"}} className="Espacio Espacio2">Lanzamiento:</p>
        <p style={{color: "white"}} className="Espacio Espacio2">Pais:</p>
        <p style={{color: "white"}} className="Espacio Espacio2">Precio:</p>
        <p style={{color: "white"}} className="Espacio Espacio2">Album:</p>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="Espacio">
            <input style={{color: "black"}}
              ...
              onChange={(e) => setFormState({ ...formState, autor: e.target.value })}
              type="text"
          ...
          <div className="Espacio">
            <input style={{color: "black"}}
              ...
              onChange={(e) => setFormState({ ...formState, clasificacion: e.target.value })}
              type="number"
          ...
          <div className="Espacio">
            <input style={{color: "black"}}
              ...
              onChange={(e) => setFormState({ ...formState, disponibleSpotify: e.target.value })}
              type="text"
          ...
          <div className="Espacio">
            <input style={{color: "black"}}
              ...
              onChange={(e) => setFormState({ ...formState, lanzamiento: e.target.value })}
              type="text"
          ...
          <div className="Espacio">
            <input style={{color: "black"}}
              ...
              onChange={(e) => setFormState({ ...formState, pais: e.target.value })}
              type="text"
          ...
          <div id="Formulario-Boton">
            <input style={{color: "black"}} type="submit" name="Mensaje" value="Enviar" className="Boton" />
          </div>
        </form>
      </div>

      <div className="Informacion">
        <h1 className="H1">Contactar Alumno:</h1>
        <ul>
          <li>
            Correo Electronico: <br />
            <p>S18003199@estudiantes.uv.mx</p>
          </li>
          <li>
            Matricula <br />
            <p>S18003199</p>
